...
public class GuidedPhraseLiveController {
    ...
    private String instruction(String scenario,int dailyRotation,int completedTurns){return """
      ...
      """.formatted(scenario,dailyRotation,completedTurns);}
}
